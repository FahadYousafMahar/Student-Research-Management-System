    ...
    <div class="col-md-9">
      ...
      <div class="row">
        <div class="col-md-12 col-lg-12">
          ...
          <h4 class="page-section-heading">Students List</h4>
          <div class="panel panel-default">
            <!-- Progress table -->
              ...
              <table class="table v-middle">
                <thead>
                  <tr>
                    ...
                    <th class="text-capitalize">Degree</th>
