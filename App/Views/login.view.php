				...
				<div class="mCustomScrollbar">
					<ul>
						...
						<!-- <li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" href="/search/" role="button" aria-haspopup="false" aria-expanded="false" tabindex='1'>Search</a>
						...
						<form class="content" action="/register" method="post">
							<div class="row">
								...
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<a href="/login"  class="btn btn-purple btn-lg full-width">Login</a>
								</div>
							</div>
						</form>
