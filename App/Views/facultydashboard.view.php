    ...
    <div class="col-md-9">
      ...
      <div class="row" data-toggle="isotope" style="position: relative; height: 674.4px;">
        <div class="item col-xs-12 col-lg-6" style="position: absolute; left: 435px; top: 314px;">
          <h4 class="text-headline margin-none">Students Under Supervision</h4>
          ...
          <?php if (count($students)>0 ):
           ...
           ?>
            ...
            <div class="panel-footer">
              <a href="/viewallstudents" class="btn btn-primary paper-shadow relative" data-z="0" data-hover-z="1" data-animated=""> View All Students</a>
            </div>
            <?php else: ?>
            <li class="list-group-item paper-shadow">
              <div class="media v-middle">
          ...
          <div class="panel panel-default paper-shadow" data-z="0.5">
           ...
           ?>
              <li class="list-group-item media v-middle">
                <div class="media-body">
                Title: <a href="/viewapaper/<?=$p->id?>" class="text-subhead list-group-link text-capitalize"><?= $p->title ?></a>
                <?php  foreach($students as $s ): if($s->id == $p->stdid): ?>
                <br>Submitted By:  <a href="" class="text-subhead list-group-link text-capitalize"><?= $s->fname.' '.$s->lname ?></a>
            ...
            <div class="panel-footer text-right">
              <a href="/viewallpapers" class="btn btn-white paper-shadow relative" data-z="0" data-hover-z="1" data-animated=""> View all</a>
            </div>
            <?php else: ?>
            <div class="panel-footer text-right">
