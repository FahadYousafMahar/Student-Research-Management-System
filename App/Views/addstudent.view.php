    ...
    <div class="col-md-9">
      ...
      <div class="row">
        <div class="panel panel-default text-center paper-shadow" data-z="0.5">
          <h1 class="text-display-1">Add New Student</h1>
          <div class="panel-body">
            <!-- Signup -->
            <form role="form" method="post" enctype="multipart/form-data" action="/addStudent">
            <div class="row">
          ...
          <div class="row">
            <div class="col-md-6 col-xs-12 col-sm-12">
              <div class="form-group">
                <div class="form-control-material">
                  <input  id="password" type="password"  name="password" class="form-control" placeholder="Password"><span class="ma-form-highlight"></span><span class="ma-form-bar"></span>
              ...
              <div class="form-group">
                <div class="form-control-material">
                  <input  id="passwordConfirmation"  name="confirmpassword"  type="password" class="form-control" placeholder="Password"><span class="ma-form-highlight"></span><span class="ma-form-bar"></span>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
              <div class="form-group">
                <div class="form-control-material">
                  <input  id="degree" type="text" name="degree" class="form-control" placeholder="Degree Programme"><span class="ma-form-highlight"></span><span class="ma-form-bar"></span>
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
              <div class="form-group">
                <div class="form-control-material">
                  <input  id="institute" type="text" name="institute" class="form-control" placeholder="Institute Name"><span class="ma-form-highlight"></span><span class="ma-form-bar"></span>
          ...
          <div class="col-md-6 col-xs-12 col-sm-12">
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
              <div class="form-group">
                <div class="form-control-material">
                  <input  id="semesteryear" type="text" name="semesteryear"  class="form-control" placeholder="Semester Year"><span class="ma-form-highlight"></span><span class="ma-form-bar"></span>
          ...
          <div class="row">
              <div class="text-center">
                <button type="submit" class="btn btn-primary">Add Student Member</button>
              </div>
          </div>
        </form>
            <!-- //Signup -->
