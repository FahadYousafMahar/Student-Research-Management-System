    ...
    <div class="col-md-9">
      <div class="panel panel-default">
        <div class="media v-middle">
          ...
          <div class="media-right media-padding">
            <a class="btn btn-white paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated="" href="/addAdmin">
            Add New Admin
        </a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-12">
          ...
          <h4 class="page-section-heading">Admins List</h4>
          <div class="panel panel-default">
            <!-- Progress table -->
                  ...
                  <tr>
                    <td>
                      <div class="checkbox checkbox-single">
                        <input id="<?=$i->id ?>" name="adminsid[]" value="<?=$i->id ?>" type="checkbox" checked="">
                    ...
                    <td class="text-right">
                      <a href="/editAdmin/<?= $i->id ?>" class="btn btn-default btn-xs ripple" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><span class="ink animate" style="height: 22px; width: 22px; top: -4px; left: -6.1875px;"></span><i class="fa fa-pencil"></i></a>
                      <a href="/deleteAdmin/<?= $i->id ?>" class="btn btn-danger btn-xs ripple" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><span class="ink animate" style="height: 22px; width: 22px; top: 1px; left: 2.3125px;"></span><i class="fa fa-times"></i></a>
                    </td>
                  </tr>
