    ...
    <div class="col-md-9">
      ...
      <div class="row">
        <div class="panel panel-default text-center paper-shadow" data-z="0.5">
          <h1 class="text-display-1">Add New Faculty</h1>
          <div class="panel-body">
            <!-- Signup -->
            <form role="form" method="post" enctype="multipart/form-data" action="/addFaculty">
            <div class="row">
          ...
          <div class="row">
            <div class="col-md-6 col-xs-12 col-sm-12">
              <div class="form-group">
                <div class="form-control-material">
                  <input  id="degree" type="text" name="education"   class="form-control" placeholder="Degree Programme"><span class="ma-form-highlight"></span><span class="ma-form-bar"></span>
