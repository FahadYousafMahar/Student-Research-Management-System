      ...
      <div class="panel panel-default">
        <div class="media v-middle">
          ...
          <div class="media-right media-padding">
            <a class="btn btn-white paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated="" href="/addPaper">
            Add New Paper
        </a>
          </div>
        </div>
              ...
              <table class="table v-middle">
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-right">
                      <a href="/viewPaper/<?= $i->id ?>" class="btn btn-default btn-xs ripple" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><span class="ink animate" style="height: 22px; width: 22px; top: -4px; left: -6.1875px;"></span><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
