...
<?php include 'partials/head.php'; ?>
  ...
  <div class="parallax cover overlay cover-image-full home">
    <img class="parallax-layer" src="/App/Views/images/photodune-4161018-group-of-students-m.jpg" alt="Learning Cover" />
  ...
  <div class="parallax cover overlay height-300 margin-none">
    <img class="parallax-layer" data-auto-offset="true" data-auto-size="false" src="/App/Views/images/photodune-6745579-modern-creative-man-relaxing-on-workspace-m.jpg" alt="Learning Cover" />
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="testimonial">
            ...
            <div class="media v-middle">
              <div class="media-left">
                <img src="/App/Views/images/people/50/guy-8.jpg" alt="People" class="img-circle width-40" />
              </div>
              <div class="media-body">
        ...
        <div class="col-md-4">
          <div class="testimonial">
            ...
            <div class="media v-middle">
              <div class="media-left">
                <img src="/App/Views/images/people/50/guy-6.jpg" alt="People" class="img-circle width-40" />
              </div>
              <div class="media-body">
                <p class="text-subhead margin-v-5-0">
                  <strong>Adrian D. <span class="text-muted">@ Mosaicpro Inc.</span></strong>
        ...
        <div class="col-md-4">
          <div class="testimonial">
            ...
            <div class="media v-middle">
              <div class="media-left">
                <img src="/App/Views/images/people/50/guy-3.jpg" alt="People" class="img-circle width-40" />
              </div>
              <div class="media-body">
                <p class="text-subhead margin-v-5-0">
                  <strong>Adrian D. <span class="text-muted">@ Mosaicpro Inc.</span></strong>
